...
PlayerQueueManagement.prototype.init = function( )
 ...
 PlayerQueueManagement.prototype.endGame = function()
    {
     this.onIntroducePlayerFunction = function() { console.log( 'SEMANTIC ERROR: INTRODUCING PLAYER WHILE NO GAME IS PLAYED' ) ; } ;
 ...
 PlayerQueueManagement.prototype.removeDisconnectingPlayer = function( id )
    {
     if( this.waitingQueue.indexOf( id ) != -1 )
        this.waitingQueue.splice( this.waitingQueue.indexOf( id ), 1 ) ;
     else
        {
