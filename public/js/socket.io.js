...
(function(exports, global) {
    ...
    util.ua.hasCORS = 'undefined' != typeof window && window.XMLHttpRequest && (function() {
        try {
...
(function(exports, io, global) {
    ...
    Socket.prototype.handshake = function(fn) {
        ...
        var url = ['http' + (options.secure ? 's' : '') + ':/', options.host + ':' + options.port, this.options.resource, io.protocol, io.util.query(this.options.query, 't=' + +new Date)].join('/');
    ...
    Socket.prototype.isXDomain = function() {
        ...
        var port = window.location.port || ('https:' == window.location.protocol ? 443 : 80);
