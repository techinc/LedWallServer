...
http.createServer(function (req, res) {
  ...
  if( req.url == '/init' )
     ...
     req.on( 'end', function()
        {
         ...
         { x: 5, y: 5, color: [ .5,.2,0 ] }, 
         { x: 5, y: 5, color: [ .2,.1,0 ] },
         { x: 5, y: 5, color: [ .17,0,0 ] },
         { x: 5, y: 5, color: [ .13,0,0 ] },
         { x: 5, y: 5, color: [ .09,0,0 ] },
         { x: 5, y: 5, color: [ .07,0,0 ] },
         { x: 5, y: 5, color: [ .06,0,0 ] },
         { x: 5, y: 5, color: [ .04,0,0 ] },
         { x: 5, y: 5, color: [ .02,0,0 ] },
         { x: 5, y: 5, color: [ .01,0,0 ] },         
         { x: 5, y: 5, color: [ 0,0,0 ] } ] ;
  ...
  else if( req.url == '/timeCycle' )
    {
     ...
     updateTail() ;
     res.end( JSON.stringify( { type: "bitmap", content: screen.toObject() } ) ) ;
    }
